...
class MyComicsViewModelFactory(private val networkRepository: NetworkRepository, private val preferencesManager: PreferencesManager, private val repository: ComicsRepository) : ViewModelProvider.Factory{
    override fun <T : ViewModel> create(modelClass: Class<T>, extras: CreationExtras): T {
        if (modelClass.isAssignableFrom(MyComicsViewModel::class.java)) {
            return MyComicsViewModel(networkRepository, preferencesManager, repository) as T
        }
